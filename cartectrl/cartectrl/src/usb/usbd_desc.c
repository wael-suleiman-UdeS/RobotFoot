...
#define USBD_MANUFACTURER_STRING        "RobotFoot team"

#define USBD_PRODUCT_HS_STRING          "RobotFoot CtrlCard"
#define USBD_SERIALNUMBER_HS_STRING     "00000000050B"

#define USBD_PRODUCT_FS_STRING          "RobotFoot CtrlCard"
#define USBD_SERIALNUMBER_FS_STRING     "00000000050C"

#define USBD_CONFIGURATION_HS_STRING    "RobotFoot config"
#define USBD_INTERFACE_HS_STRING        "RobotFoot Interface"

#define USBD_CONFIGURATION_FS_STRING    "RobotFoot config"
#define USBD_INTERFACE_FS_STRING        "RobotFoot Interface"
/**
  * @}
  */
