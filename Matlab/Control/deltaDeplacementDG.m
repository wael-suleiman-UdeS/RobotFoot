function [ePos1, eTheta1, ePos2, eTheta2, DH1, DH2  ] = deltaDeplacementDG(i,L4,L5,LTX,LTZ, q, LeftFootTraj, PelvisTraj, RightFootTraj, TPelvisTraj, TLeftTraj, TRightTraj)
...
MatBaseChange = BaseChange(TRightTraj(i,3));
...
Pe0p = RightFootPos;
Td1(1,:) = -TPelvisTraj(i,3) + TRightTraj(i,3);
